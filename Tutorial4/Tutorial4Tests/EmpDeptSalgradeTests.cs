...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result =  emps
            .Join(depts, e => e.DeptNo, d => d.DeptNo, (e, d) => new { e.EName, d.DName }).ToList();
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps
            .GroupBy(e => e.DeptNo).Select(g => new { DeptNo = g.Key, Count = g.Count() }).ToList();
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps
            .Where(e => e.Comm != null).Select(e => new { e.EName, e.Comm }).ToList();
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps
            ...
            .Select(x => new { x.EName, x.Grade }).ToList();
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps
            .Join(deptAverages, e => e.DeptNo, a => a.DeptNo,
                (e, a) => new { e.EName, e.Sal, a.AvgSal })
            .Where(x => x.Sal > x.AvgSal).Select(x => x.EName).ToList();
